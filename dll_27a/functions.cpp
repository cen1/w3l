...
DLLEXPORT int __fastcall w3l_lph_checked_rev(int *a1, int *a2, void *a3, void *a4)
{
	...
	result = w3l_logon_proof_hash_rev((char *)a2, (void *)a3, (void *)a4);
	if (result)
	{
...
/* create_account3  function copy password somewhere to stack */
DLLEXPORT __declspec(naked) int w3l_create_account3()
{
	__asm {
		push    20h
			pop     ecx
