...
#define GAME_DLL_SIZE 0xb80000
/* size of real "Game.dll" in memory */
...
/* offset of hash_init call in the logon proof password hashing routine */
#define LPH_HASH_INIT_CALL_OFFSET 0x9
/* offset of do_hash call */
#define LPH_DO_HASH_CALL_OFFSET 0x42
...
void ammend_patch(unsigned char *patch, void *data, int offset, int len) {
	unsigned char *patch_ptr = patch + offset;
